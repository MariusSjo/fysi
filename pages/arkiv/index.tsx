...
function EpisodeList({ episodes }: any) {
  ...
  return (
    <Space className="content" direction="vertical" size="middle" style={{ display: 'flex' }}>
      ...
      <Search placeholder="Søk på en podcast episode 🔈" id='search-button' style={{ paddingLeft: 20, paddingRight: 20 }} onChange={(e)=> filterEpisodes(e)} enterButton="Search" size="large" />
      <Space
        size="middle"
