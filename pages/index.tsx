...
function Index({ episodes }: any) {
  return (<>
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ position: 'absolute', zIndex: 2, bottom: '5%', margin: 0, left: '5%' }}>
        ...
        <Paragraph className='desktop'>
          Medical & health <br />
          Podcast og kunnskapsformidling for fysioterapeuter og helsepersonell.</Paragraph>
    ...
    <div className='content'>
      ...
      <Space size="large" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-evenly' }}>
      ...
      <Title style={{ textAlign: 'left', paddingTop: '3%' }}> Sjekk oss ut på sosiale medier: </Title>
      <Space size="large" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-evenly' }}>
